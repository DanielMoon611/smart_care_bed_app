...
class _MassagePage extends State<MassagePage> {
  ...
  final ValueNotifier<String> selectedMode   = ValueNotifier('MSG1');
                                                    ...
                                                    children: [
                                                      Expanded(
                                                        ...
                                                        child: GestureDetector(
                                                          ...
                                                          onTap: () {
                                                            if (massageIndex.value > 0) {
                                                              massageIndex.value--;
                                                            } else {
                                                              massageIndex.value = 5;
                                                            }
                                                            final newValue = "MSG${massageIndex.value + 1}";
                                                            selectedMode.value = newValue;
                                                            debugPrint(selectedMode.value);
                                                          },
                                                        ),
                                                      ),
                                                      ...
                                                      Expanded(
                                                        ...
                                                        child: GestureDetector(
                                                          behavior: HitTestBehavior.translucent,
                                                          onTap: () {
                                                            if (massageIndex.value < 5) {
                                                              massageIndex.value++;
                                                            } else {
                                                              massageIndex.value = 0;
                                                            }
                                                            final newValue = "MSG${massageIndex.value + 1}";
                                                            selectedMode.value = newValue;
                                                            debugPrint(selectedMode.value);
                                                        ...
                                                        return GestureDetector(
                                                          onTap: () async {
                                                            ...
                                                            if (isStart) {
                                                              ...
                                                              if (mode == '마사지') {
                                                                final command = "${selectedMode.value}/${strength.value}";
                                                                debugPrint("$mode($command)을 실행");
                                                                await BleService.I.sendToAllConnected(command.codeUnits);
                                                              } else if (mode != '마사지' || mode == '') {
                                                                mode = '마사지';
                                                                final command = "${selectedMode.value}/${strength.value}";
                                                                debugPrint("$mode($command)을 실행");
                                                                await BleService.I.sendToAllConnected(command.codeUnits);
